...
namespace RimlightArchive
{
    public class DamageWorker_Shardblade : DamageWorker_AddInjury
    {
        public override DamageResult Apply(DamageInfo dinfo, Thing thing)
        {
            ...
            if (pawn.Dead) //potential issue, dead check fails for some reason
            {
                Debug.LogError("Pawn found dead!");
                ...
                foreach (BodyPartRecord part in enumerable)
                {
                    ...
                    {
                        pawn.TakeDamage(new DamageInfo(DamageDefOf.Burn, 99999f, 999f, -1f, null, part)); //potential issue, takedamage cant be called on dead pawns?
                        break;
                    }
                }
